...
import type { NestProvidedInjectablesMap } from '../../utils/nestModules/models/NestProvidedInjectablesMap';
...
const rule = createRule({
  ...
  meta: {
    ...
    messages: {
      injectableInModule:
        "Classes marked as Injectable must be added to a module's providers. If you added it already but this error still shows in your editor, please change one character in the injectable file to poke your eslint plugin.",
      controllersInModule:
        "Classes marked as Controller must be added to a module's controllers. If you added it already but this error still shows in your editor, please change one character in the controller file to poke your eslint plugin.",
    },
    schema: [
      {
        properties: {
