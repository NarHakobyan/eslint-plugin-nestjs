...
export const apiPropertyReturningArrayShouldSetArray = createRule({
  ...
  meta: {
    ...
    messages: {
      shouldSetArrayPropertyTrue:
        'Property returning array should set array option property true',
      shouldSetArrayPropertyFalse:
        'Property not returning array should not set array option property true',
    },
    schema: [],
